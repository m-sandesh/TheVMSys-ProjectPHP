...
<div class="container">
    <br>
    <h4>Signup for Workshop Owners.</h4>
    <hr>
    <br>
    ...
    <form action="class/input.php" method="post">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="centername" name="centername" placeholder="Name of the Workshop">
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="ownername" name="ownername" placeholder="Name of Workshop Owner">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" id="open-time" name="open-time" placeholder="Opening Time of Center">
            </div>
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" id="close-time" name="close-time" placeholder="Closing Time of Center">
            </div>
            <div class="form-group col-md-1">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="schedule-time" name="schedule-time" placeholder="Scheduling Time in Center">
            </div>
        </div>
        ...
        <button type="submit" class="btn btn-success" name="btnWSReg">Register</button>
